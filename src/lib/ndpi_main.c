...
static void ndpi_init_protocol_defaults(struct ndpi_detection_module_struct *ndpi_str) {
  ...
  */
  ...
  ndpi_set_proto_defaults(ndpi_str, 0 /* encrypted */, 1 /* app proto */, NDPI_PROTOCOL_ACCEPTABLE, NDPI_PROTOCOL_PROTONVPN,
			  ...
			  ndpi_build_default_ports(ports_a, 0, 0, 0, 0, 0) /* TCP */,
			  ndpi_build_default_ports(ports_b, 0, 0, 0, 0, 0) /* UDP */);
  ndpi_set_proto_defaults(ndpi_str, 1 /* cleartext */, 0 /* nw proto */, NDPI_PROTOCOL_SAFE, NDPI_PROTOCOL_COD,
			              "COD", NDPI_PROTOCOL_CATEGORY_GAME,
			              ndpi_build_default_ports(ports_a, 0, 0, 0, 0, 0) /* TCP */,
			              ndpi_build_default_ports(ports_b, 0, 0, 0, 0, 0) /* UDP */);
  ndpi_set_proto_defaults(ndpi_str, 1 /* cleartext */, 1 /* app proto */, NDPI_PROTOCOL_FUN, NDPI_PROTOCOL_MORTAL_KOMBAT,
                          "MortalKombat", NDPI_PROTOCOL_CATEGORY_GAME,
                          ndpi_build_default_ports(ports_a, 0, 0, 0, 0, 0) /* TCP */,
                          ndpi_build_default_ports(ports_b, 0, 0, 0, 0, 0) /* UDP */);
  ndpi_set_proto_defaults(ndpi_str, 1 /* cleartext */, 1 /* app proto */, NDPI_PROTOCOL_FUN, NDPI_PROTOCOL_ROCKET_LEAGUE,
                          ...
                          ndpi_build_default_ports(ports_a, 0, 0, 0, 0, 0) /* TCP */,
                          ndpi_build_default_ports(ports_b, 0, 0, 0, 0, 0) /* UDP */);
  ndpi_set_proto_defaults(ndpi_str, 1 /* cleartext */, 1 /* app proto */, NDPI_PROTOCOL_FUN, NDPI_PROTOCOL_WORLD_OF_TANKS,
                          "WorldOfTanks", NDPI_PROTOCOL_CATEGORY_GAME,
                          ndpi_build_default_ports(ports_a, 0, 0, 0, 0, 0) /* TCP */,
                          ndpi_build_default_ports(ports_b, 0, 0, 0, 0, 0) /* UDP */);
  ndpi_set_proto_defaults(ndpi_str, 1 /* cleartext */, 1 /* app proto */, NDPI_PROTOCOL_FUN, NDPI_PROTOCOL_PING_PONG,
                          "PingPong", NDPI_PROTOCOL_CATEGORY_GAME,
                          ndpi_build_default_ports(ports_a, 0, 0, 0, 0, 0) /* TCP */,
                          ndpi_build_default_ports(ports_b, 0, 0, 0, 0, 0) /* UDP */);
...
static int ndpi_callback_init(struct ndpi_detection_module_struct *ndpi_str) {
  ...
  init_bitcoin_dissector(ndpi_str, &a);
   ...
   /* COD */
  init_cod_dissector(ndpi_str, &a);

  /* Mortal Kombat */
  init_mortal_kombat_dissector(ndpi_str, &a);

  /* RocketLeague */
  init_rocket_league_dissector(ndpi_str, &a);

  /* WorldOfTanks */
  init_world_of_tanks_dissector(ndpi_str, &a);
 
  /* PingPong */
  init_ping_pong_dissector(ndpi_str, &a);
